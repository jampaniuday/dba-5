...
where req.actual_start_date between to_date('28/04/2012 00:00:00','DD/MM/YYYY HH24:MI:SS') and to_date('04/05/2012 23:59:59','DD/MM/YYYY HH24:MI:SS')
...
and req.actual_start_date between to_date('28/04/2012 00:00:00','DD/MM/YYYY HH24:MI:SS') and to_date('04/05/2012 23:59:59','DD/MM/YYYY HH24:MI:SS')
...
where a.program_application_id=b.application_id
  ...
  and a.actual_start_date between to_date('28/04/2012 00:00:00','DD/MM/YYYY HH24:MI:SS') and to_date('04/05/2012 23:59:59','DD/MM/YYYY HH24:MI:SS')
...
and fcr.actual_start_date between to_date('28/04/2012 00:00:00','DD/MM/YYYY HH24:MI:SS') and to_date('04/05/2012 23:59:59','DD/MM/YYYY HH24:MI:SS')
...
from ood_concurrent_queues q,
ood_concurrent_queue_content c,
...
and q.creation_date <= to_date('28/04/2012 00:00:00','DD/MM/YYYY HH24:MI:SS')
...
from ood_concurrent_queues
where ENABLED_FLAG = 'Y'
and MAX_PROCESSES > 0
and RUNNING_PROCESSES > 0
and sleep_seconds != 0
and creation_date <= to_date('28/04/2012 00:00:00','DD/MM/YYYY HH24:MI:SS')
