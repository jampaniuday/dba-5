...
REM
REM $Header: 174605.1 bde_chk_cbo.sql 11.4.2.5 2011/03/07 csierra $
REM
...
PRO <html>
PRO <!-- $Header: 174605.1 bde_chk_cbo.sql 11.4.2.5 2011/03/07 csierra $ -->
...
PRO </head>
PRO <body>
PRO <h1>174605.1 bde_chk_cbo 11.4.2.5</h1>
...
PRO <br><hr size="1">
SELECT '<font class="footer">174605.1 bde_check_cbo 11.4.2.5 '||TO_CHAR(SYSDATE, 'DD-MON-YY HH24:MI')||'</font>' FROM DUAL;
PRO </body>
PRO </html>
SPO OFF
