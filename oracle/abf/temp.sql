...
------------------------ Seleciona total ocupado por cada instance na tablespace temp  --------
...
prompt;
prompt  ********* Dados das duas sessoes que mais consomem temp EBS ;
...
from
   ------------------------ Seleciona total ocupado por cada instance na tablespace temp para calcular os percentuais --------
        (select   texp.inst_id
                  ,ins.instance_name
                  ,texp.tablespace_name
                  ,trunc(sum(BYTES_USED/1024/1024)) as usado
   ...
   ------------------------- Seleciona as 3(RN) sessoes que mais consomem temp em cada instance --------------
