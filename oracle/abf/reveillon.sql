...
prompt #EXECS PER DAY
select trunc(req.actual_completion_date) DIA,
count(*) CONCS
from ood_concurrent_requests req
where req.actual_start_date between to_date('28/12/2012 00:00:00','DD/MM/YYYY HH24:MI:SS') and to_date('04/01/2013 23:59:59','DD/MM/YYYY HH24:MI:SS')
...
and req.actual_start_date between to_date('28/12/2012 00:00:00','DD/MM/YYYY HH24:MI:SS') and to_date('04/01/2013 23:59:59','DD/MM/YYYY HH24:MI:SS')
...
where a.program_application_id=b.application_id
  ...
  and a.actual_start_date between to_date('28/12/2012 00:00:00','DD/MM/YYYY HH24:MI:SS') and to_date('04/01/2013 23:59:59','DD/MM/YYYY HH24:MI:SS')
...
and fcr.actual_start_date between to_date('28/12/2012 00:00:00','DD/MM/YYYY HH24:MI:SS') and to_date('04/01/2013 23:59:59','DD/MM/YYYY HH24:MI:SS')
